...
export async function genChartByAiUsingPost(
  ...
  return request<API.BaseResponseBiResponseVO_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAnsyc POST /api/chart/gen/async */
export async function genChartByAiAnsycUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByAiAnsycUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponseVO_>('/api/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAnsycMq POST /api/chart/gen/async/mq */
export async function genChartByAiAnsycMqUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByAiAnsycMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponseVO_>('/api/chart/gen/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** listChartByPage POST /api/chart/list */
export async function listChartByPageUsingPost1(
  body: API.ChartQueryRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageChart_>('/api/chart/list', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** deleteChart POST /api/chart/remove/chart */
export async function deleteChartUsingPost(body: number, options?: { [key: string]: any }) {
  return request<API.BaseResponse>('/api/chart/remove/chart', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** reSendChatGpt POST /api/chart/reSendChatGpt */
export async function reSendChatGptUsingPost(body: number, options?: { [key: string]: any }) {
  return request<any>('/api/chart/reSendChatGpt', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** loginSingIn POST /api/chart/singin */
export async function loginSingInUsingPost(body: number, options?: { [key: string]: any }) {
  return request<API.BaseResponse>('/api/chart/singin', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
